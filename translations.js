...
export const translations = {
  en: {
    ...
    modelHelp: "Qwen 3 32B provides the best quality for text processing",
  ...
  de: {
    ...
    modelHelp: "Qwen 3 32B bietet die beste Qualität für die Textverarbeitung",
  ...
  es: {
    ...
    modelHelp: "Qwen 3 32B proporciona la mejor calidad para el procesamiento de texto",
  ...
  fr: {
    ...
    modelHelp: "Qwen 3 32B offre la meilleure qualité pour le traitement du texte",
  ...
  it: {
    ...
    modelHelp: "Qwen 3 32B offre la migliore qualità per l'elaborazione del testo",
  ...
  pt: {
    ...
    modelLabel: "Modelo LLM:",
    modelHelp: "Qwen 3 32B oferece a melhor qualidade para processamento de texto",
